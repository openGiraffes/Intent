export default function(a) {
    ...
    function l() {
        for (var a = "", c = 0, d = 0, e = 3; e >= 0; e--)
            (d = arguments[e]), (c = 255 & d), (d >>>= 8), (c <<= 8), (c |= 255 & d), (d >>>= 8), (c <<= 8), (c |= 255 & d), (d >>>= 8), (c <<= 8), (c |= d), (a += b(c));
        return a;
    }
    function m(a) {
    ...
    return (
        "string" == typeof a
            ...
            ? a instanceof ArrayBuffer
                ? (p = m(new Uint8Array(a)))
                : a instanceof Uint8Array || a instanceof Int8Array
                ? (p = m(a))
                : a instanceof Uint32Array || a instanceof Int32Array || a instanceof Uint16Array || a instanceof Int16Array || a instanceof Float32Array || a instanceof Float64Array
                ? (p = m(new Uint8Array(a.buffer)))
                : (q = typeof a)
            : (q = typeof a),
